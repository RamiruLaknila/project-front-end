...
const getStoredAgent = () => {
  try {
    ...
    console.error("Failed to load individual agent profile:", error);
  }
...
function IndividualAgentSidebar() {
  ...
  useEffect(() => {
    ...
    window.addEventListener("individualAgentProfileUpdated", handleProfileUpdate);
    window.addEventListener("agentProfileUpdated", handleProfileUpdate);
    window.addEventListener("storage", handleProfileUpdate);

    return () => {
      window.removeEventListener(
        "individualAgentProfileUpdated",
        handleProfileUpdate
      );
      window.removeEventListener(
        "agentProfileUpdated",
...
export default IndividualAgentSidebar;