...
const NOTIFICATIONS = [
  {
    id: "i1",
    type: "request",
    title: "New shipment request nearby",
    description: "A new clearing request matching your specialization was posted.",
    time: "12 minutes ago",
    unread: true,
  },
  {
    ...
    description: "Your bid for shipment request IMP-3021 was accepted.",
    time: "1 hour ago",
    unread: true,
  },
  {
    ...
    description: "You have a new message about an active shipment.",
    time: "4 hours ago",
    unread: true,
  },
  {
    ...
    description: "The SME uploaded a packing list for your review.",
    time: "Yesterday",
    unread: false,
  },
  {
    id: "i5",
    type: "shipment",
    title: "Shipment marked complete",
    description: "One of your active shipments has been marked as completed.",
    time: "4 days ago",
    unread: false,
  },
];
...
const TYPE_META = {
  request: { icon: Package, style: "bg-blue-50 text-[#2563EB]" },
  ...
  shipment: { icon: CheckCircle, style: "bg-emerald-50 text-emerald-600" },
};
...
function IndividualAgentNotifications() {
            ...
            {visibleItems.length === 0 ? (
              <div className="flex flex-col items-center justify-center px-6 py-16 text-center">
                ...
                <p className="mt-1 max-w-xs text-[13px] leading-5 text-slate-400">
                  New requests, bids and messages will show up here.
                </p>
              </div>
            ) : (
              <ul className="divide-y divide-slate-100">
                {visibleItems.map((item) => {
                  const meta = TYPE_META[item.type] || TYPE_META.shipment;
...
export default IndividualAgentNotifications;
