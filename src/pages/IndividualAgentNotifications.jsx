...
// Where a click on a notification should take an individual agent, based on its `type`.
function notificationLink(item) {
  switch (item.type) {
    case "direct_request":
      return "/individual-agent-requests";
    case "bid_accepted":
      return "/individual-agent-shipments";
    case "bid_rejected":
    case "tender_withdrawn":
      return "/individual-agent-bids";
    default:
      return null;
  }
}
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center px-6 py-16 text-center">
                ...
                <p className="mt-1 max-w-xs text-[13px] leading-5 text-slate-400">
                  New requests, bids and pitches will show up here.
                </p>
              </div>
            ) : (
